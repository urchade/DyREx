...
def main():
    ...
    parser.add_argument("--self_attention_type", default="bidirectional", type=str, help="Attention type for dyrex decoder")
    parser.add_argument("--num_layers", default=3, type=int, help="Num. of layers for dyrex decoder")
    ...
    if args.do_train and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        model = DyRexQA.from_pretrained(args.output_dir, config=config,
                                        num_layers=args.num_layers, self_attention_type=args.self_attention_type,
                                        cache_dir=args.cache_dir if args.cache_dir else None)
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        ...
        for checkpoint in checkpoints:
            ...
            model = DyRexQA.from_pretrained(checkpoint, num_layers=args.num_layers, self_attention_type=args.self_attention_type, cache_dir=args.cache_dir if args.cache_dir else None)
